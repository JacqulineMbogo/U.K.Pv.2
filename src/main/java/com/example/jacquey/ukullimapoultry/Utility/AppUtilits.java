package com.example.jacquey.ukullimapoultry.Utility;
...
public class AppUtilits {
    ...
    public static void destroyDialog(AlertDialog dialog)
    {
        ...
        public static void UpdateCartCount(final Context mContext, Menu mainmenu){
            ...
            cartcount.setText( String.valueOf(SharedPreferenceActivity.getInstance().getInteger(Constant.CART_ITEM_COUNT)));

            if (SharedPreferenceActivity.getInstance().getInteger(Constant.CART_ITEM_COUNT)>0){
            ...
            item.getActionView().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext, com.example.jacquey.ukullimapoultry.cart.CartDetails.class);
