...
public class BestSelling_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<DuckProd_Model> mBestSellingModelList;
    private String TAG ="BestSelling_adapter";
    private int mScrenwith;

    public BestSelling_Adapter(Context context, List<DuckProd_Model> list, int screenwidth ){
        mContext = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        final DuckProd_Model model = mBestSellingModelList.get(position);
