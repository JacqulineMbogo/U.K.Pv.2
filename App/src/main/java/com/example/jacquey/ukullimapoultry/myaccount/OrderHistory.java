...
public class OrderHistory extends AppCompatActivity {
    ...
    public void getUserOrderHistory(){
        if (!NetworkUtility.isNetworkConnected(OrderHistory.this)){
            ...
            Call<OrderHistoryAPI> call = service.getorderhistorycall("1234", SharedPreferenceActivity.getInstance().getString(Constant.USER_DATA));
    ...
    public void onBackPressed() {
        ...
        Intent intent1 = new Intent(OrderHistory.this, MainActivity.class);
