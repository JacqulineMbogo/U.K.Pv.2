...
public class Order_Summary extends AppCompatActivity {
    ...
    public void getUserCartDetails(){
        ...
        if (!NetworkUtility.isNetworkConnected(Order_Summary.this)){
            ...
            Call<OrderSummary> call = service.getOrderSummarycall("1234" , SharedPreferenceActivity.getInstance().getString(Constant.USER_DATA),
                    SharedPreferenceActivity.getInstance().getString(Constant.QUOTE_ID));
